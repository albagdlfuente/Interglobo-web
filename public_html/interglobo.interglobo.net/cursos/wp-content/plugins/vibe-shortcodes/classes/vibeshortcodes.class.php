...
class VibeShortcodes {
    ...
    function admin_icons($hook){
    	if(is_admin() && ( in_array( $hook, array( 'post-new.php', 'post.php' ) ) || ($hook == 'lms_page_lms-settings' && $_GET['page'] == 'lms-settings' && $_GET['tab'] == 'general' && $_GET['sub'] == 'loggedin_menu') ) ){
