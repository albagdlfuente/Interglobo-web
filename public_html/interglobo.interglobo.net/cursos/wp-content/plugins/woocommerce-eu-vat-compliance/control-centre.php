...
// 					error_log("NOT FOUND: ".$setting['id']);
			...
			if ((file_exists(dirname(__FILE__).'/eu-vat-compliance-premium.php') && ($fp = fopen(dirname(__FILE__).'/eu-vat-compliance-premium.php', 'r'))) || (file_exists(dirname(__FILE__).'/eu-vat-compliance.php') && ($fp = fopen(dirname(__FILE__).'/eu-vat-compliance.php', 'r')))) {
