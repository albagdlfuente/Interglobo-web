...
// 		add_option('woocommerce_eu_vat_compliance_vat_match', $this->default_vat_matches);
		...
		$this->wc_compat = WooCommerce_EU_VAT_Compliance('WooCommerce_Compat_0_2');
		
		if (file_exists(WC_EU_VAT_COMPLIANCE_DIR.'/updater.php')) include_once(WC_EU_VAT_COMPLIANCE_DIR.'/updater.php');
