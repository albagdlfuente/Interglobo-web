...
* COMPATIBILITY: Updated for WooCommerce 3.0 (tested with release canidate 2)
...
== Upgrade Notice ==
* 1.11.3 : Fix a bug which prevented WooCommerce's "Tax based on shipping address" from working correctly
